...
//		int radius = 20;
//		System.out.println("넓이: " + 2 * PI * Math.pow(radius, 2) + ", 둘레: " + 4 * PI * radius);
//
//		// 04
//
//		Scanner sc = new Scanner(System.in);
...
//		}
//		Arrays.sort(arr);
//		System.out.println("최소값: " + arr[0] + ", 중간값: " + arr[1] + ", 최대값: " + arr[2]);
//		sc.close();
//
//		// 06
//
...
//		System.out.print("값: ");
//		double a = sc.nextDouble();
//		System.out.println(a + "의 제곱: " + Double.toString(Math.pow(a, 2)));
//		sc.close();
//
//		// 05
//
...
//		System.out.print(++num + ", ");
//		System.out.print(--num + ", ");
//		System.out.print("마지막 변수의 값: " + (num + 1));
//
//		// 03
//
//		Scanner sc = new Scanner(System.in);
...
//		System.out.print("값: ");
//		int num = sc.nextInt();
//		System.out.println((num >= 100) ? (num > 100) ? "100보다 큼" : "100" : "100보다 작음");
//		sc.close();
//
//		// 07
//
...
//		}
//		Arrays.sort(arr);
//		System.out.println("가장 큰 수: " + arr[4]);
//		sc.close();
//
//		// 07
//
...
//		else {
//			System.out.println("짝수 : " + evenCount + "개, 홀수 : " + (3 - evenCount) + "개 입니다.");
//		}
//		sc.close();
//
//		// --------------------반복문--------------------
...
//		int b = sc.nextInt();
//		int gcd = getGCD(a, b);
//		System.out.println("최소공배수: " + ((a * b) / gcd) + ", 최대공약수: " + gcd);
//		sc.close();
//
//		// 08-1
//
