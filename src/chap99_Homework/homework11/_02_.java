...
//			}
//		}
//		System.out.println("길이가 긴 문자열: " + str1 + ", 길이가 작은 문자열: " + str2);
//		sc.close();
//
//		// 07
//
...
//			}
//		}
//		System.out.println("인덱스: " + index + ", 문자열: " + arr[index]);
//		sc.close();
//
//		// --------------------클래스--------------------
//
...
//		s.setStudentInfo("민수정", 20201944, "컴퓨터학부");
//		s.printStudentInfo();
//
//		// 02
//
//		Book b = new Book();
//		b.setBookInfo("안드로이드는 전기양의 꿈을 꾸는가?", "필립 K. 딕", "폴라북스", 18000);
//		b.printBookInfo();
//
...
//		System.out.println("넓이: " + c.getArea() + ", 둘레: " + c.getCircumference());
//
//		// 06
//
//		BankAccount ba = new BankAccount(10000L);
//		ba.balanceInquiry();
//		ba.deposit(50000L);
//		ba.balanceInquiry();
//		ba.withdraw(5000L);
...
//		// 02
//
//		Arbeit a = new Arbeit(5, 9860);
//		a.work();
//		Arbeit b = new Cashier(5, 8800);
//		b.work();
//		Arbeit c = new Coupangman(5, 10030);
//		c.work();
//
//		// 03
//
...
//
//		if (voca.containsKey(str))
//			System.out.println(str + " : " + voca.get(str));
//		sc.close();
//
//		// 02
//
...
//			System.out.println("최종금액 : " + (menu.get(str) * num) + "원");
//		sc.close();
//
//		// 03
//
...
//		System.out.print("문자열: ");
//		String str = sc.nextLine();
//		System.out.println("인덱스: " + list.indexOf(str));
//		sc.close();
//
//		// 06
//
...
//
//		Map.Entry<String, Integer> hMap = null;
//		for (Map.Entry<String, Integer> entry : hyundai.entrySet()) {
//			if (hMap == null || entry.getValue() > hMap.getValue()) {
//				hMap = entry;
//			}
//		}
//		list.add(hMap);
//
//		Map.Entry<String, Integer> kMap = null;
//		for (Map.Entry<String, Integer> entry : kia.entrySet()) {
//			if (kMap == null || entry.getValue() > kMap.getValue()) {
//				kMap = entry;
//			}
//		}
//		list.add(kMap);
