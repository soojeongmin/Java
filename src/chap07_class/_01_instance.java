...
public class _01_instance {
	...
	public static void main(String[] args) {
		...
		// 그 변수들과 메소드를 사용할 수 있는 클래스타입의 값이 객체로 하나 만들어지게된다.
		// 인스턴스화 방식: new 생성자();
		car = new Car();
	...
	public static Car generateCar(Car c) {
		Car  returnCar = new Car();
		
		returnCar.company = c.company;
		returnCar.color = c.color;
		returnCar.model = c.model;
		returnCar.price = c.price;
