...
public class CarConstructor {
	...
	// 접근제어자 + 클래스명(매개변수)로 지정
	// 매개변수가 없는 생성자를 기본생성자라고 하며
	// 생성자를 정의하지 않았을 때 기본으로 제공된다.
	// 생성자는 객체를 생성하면서 속성들을 초기화할때 주로 사용한다.
	...
	// 매개변수 생성자에서 어떤 변수를 초기화하는 명확하게 하기 위해서 
	// 속성 변수명과 일치시키는게 관례적이다.	
	// 매개변수가 있는 생성자를 생성하면 기본 생성자가 제공되지 않기 때문에 항상
	// 기본 생성자 먼저 정의를 해주고 다른 생성자들을 정의한다.
