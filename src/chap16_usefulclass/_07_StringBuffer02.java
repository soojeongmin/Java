...
public class _07_StringBuffer02 {
	...
	public static void main(String[] args) {
		...
		// sb3는 16 크기의 버퍼를 생성해서 append 메소드로 문자열을 추가했기 때문에
		...
		// 5. insert: 첫번째 매개변수 위치에 두번째 값을 삽입
		sb2.insert(3, "c");
		System.out.println(sb2);
		
		// 6. reverse: StringBuffer에 저장되어있는 문자열을 역순으로 정렬
		sb2.reverse();
		System.out.println(sb2);
		
		// 7. setCharAt: 첫번째 매개변수로 주어진 인덱스 위치에 있는 문자를 두번째 매개변수로 주어진 값으로 변경
		sb2.setCharAt(2,  'u');
		System.out.println(sb2);
