...
public class _03_String02 {
	...
	public static void main(String[] args) {
		...
		// 2. indexOf, lastIndexOf: 특정문자나 문자열의 index를 리턴하는 메소드
		// 포함되어있으면 해당 문자의 인덱스 찾아서 리턴, 포함되어 있지 않으면 -1 리턴
		...
		// 배열에서는 length가 메소드가 아니도 속성 값(멤버변수)이다.
		int[] intArr = new int[100];
		System.out.println("intArr의 길이는 " + intArr.length);

		// List의 길이는 size메소드를 사용한다.
		...
		// 4. replace, replaceAll: 문자열에서 주어진 첫 번째 매개변수를 찾아서 두번째 매개변수로
		...
		// replaceAll에서 정규표현식사용
		// str4에 있는 a, c를 2로 치환하라
