...
public class _15_BigInteger {
	...
	public static void main(String[] args) {
		// 1. BigInteger 객체 생성
		// 1-1. 생성자를 통한 객체 생성
		BigInteger bigInt1 = new BigInteger("1000000000000000000000000000000000");
		
		// 1-2. valueOf 메소드를 통한 객체 생성
		BigInteger bigInt2 = BigInteger.valueOf(30000000000000000L);
		
		// 2. toString: 객체에 저장되어 있는 값을 String 타입으로 변환
		// Object의 toString메소드가 오버라이드 되어있다.
		...
		// 덧셈, 뺄셈, 곱셈, 나눗셈, 나머지 연산을 모세드를 통해 진행한다.
