...
public class _01_Calendar {
	...
	public static void main(String[] args) {
		...
		System.out.println("현재 시간은 " + calendar.get(Calendar.HOUR_OF_DAY) + ":" + calendar.get(Calendar.MINUTE) + ":"
		...
		// DATE(현재 날짜의 일자 표시)
		System.out.println("현재 날짜는 " + calendar.get(Calendar.YEAR) + "-"
		...
		oneDay.set(2024, 3, 24, 22, 53, 30); // 2024년 4월 24일 9시 53분 30초를 갖는 Calendar 객체
	...
	public static String TimeToString(Calendar calendar) {
		return (calendar.get(Calendar.AM_PM)==0? calendar.get(Calendar.HOUR): 12+calendar.get(Calendar.HOUR))+"시 "+calendar.get(Calendar.MINUTE)+"분 "+calendar.get(Calendar.SECOND)+"초";
	}
}
