...
public class _09_Optional {
	...
	public static void main(String[] args) {
		...
		// 값이 존재하면 true, null이면 false를 리턴
		if(optionalStr.isPresent()) {
			for(int i=0;i<optionalStr.get().length();i++) {
				// NullPointerException을 샤샷~ 피함
			}
		}
		...
		else System.out.println(optionalStr);
		...
		if(optionalStr2.isPresent()) System.out.println(optionalStr.get());
